...
#### Construir uma API Rest com o java

#### Conexao com o banco de dados mysql

#### Uso da bibrioteca Maven 
...
- A modelagem do banco de babdos se encontra na pasta 'diagram'

- Na pasta 'teste-api' se encontra a coleção para importar no postman para testar a API

- A pasta ForumAlura é a API.
...
1. Faça o **fork** do project. No lado superior direito, ao clicar no ícone ele criará um repositório do projeto em sua conta pessoal do GitHub.
