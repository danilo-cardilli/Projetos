...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		btnSair.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/sair.png")));
		btnSair.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				int resposta = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja sair?", "Confirm", JOptionPane.OK_CANCEL_OPTION);
		...
		btnSair.setBounds(819, 406, 91, 93);
		panel.add(btnSair);
	}
